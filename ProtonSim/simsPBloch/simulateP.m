...
%%End the bloch portion of the simulation
    ...
    signalNil = signalNil + exp(complex(intrinsicPhase,totPhase));
	signal = magnetization(1,:);
end
figure;title('simulatePnew');subplot(5,1,1);plot(t,magnetization(1,:));subplot(5,1,2);plot(t,magnetization(2,:));subplot(5,1,3);subplot(5,1,4);plot(t,abs(complex(magnetization(1,:),magnetization(2,:))));plot(t,real(signalNil));subplot(5,1,5);plot(t,imag(signalNil));
