function [xTemp, yTemp, zTemp] = placeSinusoidalSpheresM9P(sinusoidCount,numSpheresSinusoidEach,xTemp,yTemp,zTemp,R_select,cylinderDiameter,nnCDF,nnDist,NNfactorS)
