function [cellSpheres,cellInfo,xTemp,yTemp,zTemp,cellIndx,cellFillCounter,R_select_orig,R_select,nnDist,nnPDF,nnCDF] = placeSpheresM7(NNfactor,patientInfo,patientIndx,xTemp,yTemp,zTemp,sim_box_side,R_select,hepatocyte_dim);
...
%% accounted for.
%% 3 May, 2007, unlike M6 version, here new sphere is placed with respect
%% to random sphere already placed instead of the last one placed.
